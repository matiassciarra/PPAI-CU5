...
public class BodegaRepositorio {
    public List<Bodega> findAll() {
        ...
        Bodega bodega1 = new Bodega(4L,"a", dia1, "bodega1", 2);
        Bodega bodega2 = new Bodega(5L,"b", dia2, "bodega2", 2);
        Bodega bodega3 = new Bodega(6L, "c", dia1, "bodega3", 2);
        Bodega bodega4 = new Bodega(7L,"d", dia2, "bodega4", 2);
        Bodega bodega5 = new Bodega(8L, "e", dia1, "bodega5", 2);
        Bodega bodega6 = new Bodega(9L, "f", dia2, "bodega6", 2);
